            ...
            <form onSubmit={handleSubscribe} className="w-full">
              <div className="relative w-full">
                <input
                  ...
                  className="bg-transparent border border-[#7f614f] rounded-md text-white px-4 py-2 w-full pr-12 focus:outline-none focus:border-[#7f614f]"
                  required
                />
                <button
                  type="submit"
                  className="absolute inset-y-0 right-0 flex items-center px-3 bg-[#7f614f] rounded-r-md hover:bg-[#6a5242] transition-colors"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 flex-wrap">
            ...
            <div className="flex flex-wrap gap-6">
              <button
                ...
                className="hover:text-[#7f614f] transition-colors"
              >
                Terms & Conditions
              </button>
              <button
